...
$evrsn_icons = array(
    "<img src='" . e_IMAGE . "admin_images/noinstall.png' alt='Blank' title='' />",
...
<tr><td class='fcaption' colspan=5' >Plugin Update Check</td></tr>
		<tr>
			...
			<td class='forumheader2'>Plugin Manage Detects</td>
...
foreach($evrsn_datalist as $row)
{
    ...
    $evrsn_text .= $pm . "</td>
<td class='forumheader3' style='vertical-align:top;'>" . (!empty($row['dlpath'])?"<a href='" . $row['dlpath'] . "' target='_blank' ><img src='" . e_IMAGE . "generic/" . IMODE . "/download.png' style='border:0;'></a>":"&nbsp;") . "</td>
		</tr>";
}
$evrsn_text .= "
		<tr>
